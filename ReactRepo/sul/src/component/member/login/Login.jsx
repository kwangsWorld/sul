    ...
    return (
        <StyledLoginDiv>
            <form onSubmit={handleClickLogin}>
                <table>
                    <tr>
                        <td><input type='text' name='id' placeholder='아이디' onChange={handleInputChange} /></td>
                    </tr>
                    <tr>
                        <td><input type='password' name='pwd' placeholder='비밀번호' onChange={handleInputChange} /></td>
                    </tr>
                    <tr>
